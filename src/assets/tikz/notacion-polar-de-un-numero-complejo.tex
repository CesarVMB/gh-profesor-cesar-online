...
\begin{document}
  \begin{tikzpicture}
    ...
    \filldraw[red] (4,4) circle(1pt) node[black,above right]{$z=(a,b)$};
    ...
    \draw[ultra thin,-latex] (1,0) arc (0:45:1);
    \draw (1,0.25) node[above right]{$\theta$};
  \end{tikzpicture}
\end{document}
